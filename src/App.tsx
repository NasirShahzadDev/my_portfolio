...
const NavLinks = ({ className = "", onClick = () => {} }) => (
  <div className={`flex items-center gap-8 ${className}`}>
    ...
    <a href={CONFIG.resumeUrl} download className="px-5 py-2 rounded-full border border-indigo-500/30 text-indigo-400 hover:bg-indigo-500/10 transition-all flex items-center gap-2">
...
export default function App() {
  ...
  return (
    <div className="min-h-screen font-sans">
        ...
        {selectedProject && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-6">
            ...
            <motion.div 
              ...
              className="relative w-full max-w-4xl max-h-[90vh] flex flex-col rounded-[3rem] glass border border-white/10 shadow-2xl overflow-hidden"
            >
              <div 
                ref={modalScrollRef}
      ...
      {/* Header */}
      <header className="fixed top-0 left-0 w-full z-50 glass py-5">
        <div className="container mx-auto px-6 flex justify-between items-center">
          <div className="flex items-center gap-10">
            <div className="text-2xl font-black tracking-tighter">NASIR<span className="text-indigo-500">.</span></div>
      ...
      <AnimatePresence>
        {isMenuOpen && (
          <motion.div 
            ...
            exit={{ opacity: 0, y: -20 }}
            className="lg:hidden fixed inset-0 z-40 bg-[#0a0a0c] pt-24 px-6"
          >
            <div className="flex flex-col gap-8 text-xl font-bold uppercase tracking-widest text-zinc-400">
              <NavLinks className="flex-col items-start" onClick={() => setIsMenuOpen(false)} />
              <div className="pt-8 border-t border-white/5 flex gap-6">
                <a href={CONFIG.github} target="_blank"><Github size={24} /></a>
                <a href={CONFIG.linkedin} target="_blank"><Linkedin size={24} /></a>
                <a href={`mailto:${CONFIG.email}`}><Mail size={24} /></a>
              </div>
            </div>
          </motion.div>
        )}
      ...
      {/* Hero Section */}
      <section id="about" className="pt-48 pb-24 relative overflow-hidden bg-[#0a0f1e]">
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-5xl">
            ...
            >
              ...
              <h1 className="text-4xl lg:text-7xl font-black tracking-tighter leading-[0.95] mb-12 text-gradient">
                ARCHITECTING HIGH-PERFORMANCE<br />BACKEND ECOSYSTEMS
              </h1>
              <p className="text-slate-300 text-lg lg:text-xl max-w-3xl mb-16 leading-relaxed text-justify border-l-2 border-cyan-500/20 pl-8">
                {CONFIG.summary}
              </p>
              
              <div className="flex flex-wrap gap-6 mb-24">
                <a href="#projects" className="px-10 py-5 rounded-2xl bg-indigo-600 text-white font-black uppercase tracking-widest hover:bg-indigo-500 transition-all duration-300 shadow-lg shadow-indigo-600/30">
                  Explore Projects
                </a>
                <a href={CONFIG.whatsapp} target="_blank" className="px-10 py-5 rounded-2xl border border-slate-700 text-slate-200 font-black uppercase tracking-widest hover:bg-slate-800 transition-all duration-300 backdrop-blur-sm">
                  Get in Touch
                </a>
              </div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-8 lg:gap-12">
                {[
                  ...
                  <div key={i} className="relative group">
                    <div className="text-4xl lg:text-5xl font-black mb-2 text-white group-hover:text-cyan-400 transition-colors">{stat.value}</div>
                    <div className="text-[9px] font-bold uppercase tracking-widest text-slate-400 group-hover:text-slate-300 transition-colors">{stat.label}</div>
                  </div>
                ))}
              </div>
            </motion.div>
      ...
      <section className="py-24 relative overflow-hidden bg-[#111827]">
        ...
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
            ...
            >
              <div className="relative group w-full max-w-[320px] md:max-w-md lg:max-w-none">
                <div className="absolute -inset-4 bg-cyan-500/20 rounded-[3rem] lg:rounded-[4rem] blur-2xl group-hover:bg-cyan-500/30 transition-all duration-700" />
                <div className="relative aspect-square lg:aspect-[4/5] rounded-[2.5rem] lg:rounded-[3.5rem] overflow-hidden border border-slate-700 shadow-2xl bg-[#0a0f1e]">
                  <img 
                  ...
                  <div className="absolute bottom-8 left-8 lg:bottom-10 lg:left-10">
                    <div className="text-xl lg:text-2xl font-black tracking-tight text-white">{CONFIG.name}</div>
                    <div className="text-cyan-400 font-bold uppercase tracking-widest text-[9px] lg:text-[10px]">Architecting Excellence</div>
                  </div>
                </div>
              </div>
            </motion.div>
            ...
            >
              <div className="space-y-4">
                ...
                <h2 className="text-4xl lg:text-6xl font-black tracking-tighter text-white">Professional Profile</h2>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-6">
                {[
                  ...
                  <div key={i} className="flex items-center gap-4 p-5 lg:p-6 rounded-2xl lg:rounded-3xl bg-[#0a0f1e]/50 border border-slate-700 hover:border-cyan-500/30 transition-all group">
                    ...
                    <div>
                      <div className="text-[9px] font-bold uppercase tracking-widest text-slate-500">{item.label}</div>
                      <div className="text-xs lg:text-sm font-bold text-slate-200">{item.value}</div>
                    </div>
                  </div>
                ))}
              </div>
      ...
      <section className="py-32 bg-[#111827]">
        <div className="container mx-auto px-6">
          <div className="text-center max-w-3xl mx-auto mb-24">
            <h2 className="text-4xl lg:text-6xl font-black tracking-tighter mb-6 text-white">Technical Arsenal</h2>
            <p className="text-slate-400 text-lg">A comprehensive overview of the technologies and methodologies I employ to build high-performance systems.</p>
          </div>
      ...
      {/* Experience Section */}
      <section id="experience" className="py-32 relative overflow-hidden bg-[#0a0f1e] border-y border-slate-900">
        <div className="absolute top-1/2 left-0 w-[40%] h-[40%] bg-cyan-600/10 blur-[150px] rounded-full -z-10" />
        
        <div className="container mx-auto px-6">
          <h2 className="text-4xl lg:text-6xl font-black tracking-tighter mb-24 text-white">Professional Experience</h2>
          <div className="space-y-12">
            {EXPERIENCE.map((exp, i) => (
              <motion.div 
                ...
                whileInView={{ opacity: 1, x: 0 }}
                viewport={{ once: true }}
                className="p-12 rounded-[3.5rem] bg-[#111827]/60 backdrop-blur-xl border border-slate-800/50 shadow-2xl"
              >
                <div className="flex flex-col lg:flex-row justify-between items-start gap-10">
                  <div className="lg:w-1/3">
                    <div className="flex items-center gap-4 mb-6">
                      ...
                      <div>
                        <h3 className="text-2xl font-black text-slate-100">{exp.company}</h3>
                        <p className="text-cyan-400 font-bold uppercase tracking-widest text-[10px]">{exp.period}</p>
                      </div>
                    </div>
                    <div className="text-xl font-bold text-slate-300 mb-2">{exp.role}</div>
                  ...
                  <div className="lg:w-2/3">
                    <ul className="space-y-4">
                      {exp.bullets.map((bullet, idx) => (
                        <li key={idx} className="flex items-start gap-4 text-slate-400 leading-relaxed">
      ...
      {/* Projects Section */}
      <section id="projects" className="py-32 relative overflow-hidden bg-[#111827]">
        <div className="absolute bottom-0 right-0 w-[50%] h-[50%] bg-cyan-600/10 blur-[160px] rounded-full -z-10" />
        
        <div className="container mx-auto px-6">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-24 gap-8">
            <h2 className="text-4xl lg:text-6xl font-black tracking-tighter max-w-2xl text-white">Key Projects</h2>
            <a href={CONFIG.github} target="_blank" className="flex items-center gap-3 text-xs font-black uppercase tracking-widest text-cyan-400 hover:text-white transition-colors group">
            ...
            {PROJECTS.map((project, i) => (
              ...
              >
                <div className={`lg:col-span-7 ${i % 2 !== 0 ? 'lg:order-2' : ''}`}>
                  <div className="aspect-[16/9] rounded-[4rem] overflow-hidden border border-slate-800 relative shadow-2xl bg-[#0a0f1e]">
                    <img 
                      src={project.image} 
                      alt={project.title} 
                ...
                <div className="lg:col-span-5">
                  <div className="text-cyan-400 font-black uppercase tracking-[0.3em] text-[10px] mb-4">{project.subtitle}</div>
                  <h3 className="text-4xl font-black mb-6 text-slate-100 group-hover:text-cyan-400 transition-colors">{project.title}</h3>
                  <p className="text-slate-400 text-lg mb-10 leading-relaxed">{project.description}</p>
                  <div className="flex flex-wrap gap-3 mb-12">
                    {project.tech.map(t => (
                      <span key={t} className="px-4 py-2 rounded-xl bg-[#0a0f1e] border border-slate-800 text-[10px] font-bold text-slate-500 uppercase tracking-widest">
                        {t}
                      </span>
                    ))}
                  </div>
                  <button 
                    ...
                    className="inline-flex items-center gap-3 text-xs font-black uppercase tracking-widest text-cyan-400 hover:text-white transition-colors"
                  >
      ...
      {/* Education & Certs */}
      <section className="py-32 bg-[#111827] border-y border-slate-800">
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-24">
            <div>
              <h2 className="text-4xl lg:text-6xl font-black tracking-tighter mb-20 text-white">Education</h2>
              <div className="space-y-12">
                {EDUCATION.map((edu, i) => (
                  <motion.div 
                    key={i}
                    ...
                    whileInView={{ opacity: 1, y: 0 }}
                    viewport={{ once: true }}
                    className="relative pl-12 border-l-2 border-cyan-500/20"
                  >
                    <div className="absolute top-0 left-[-9px] w-4 h-4 rounded-full bg-cyan-500 shadow-[0_0_15px_rgba(6,182,212,0.5)]" />
                    <h3 className="text-2xl font-black mb-2 text-slate-100">{edu.degree}</h3>
                    <p className="text-slate-400 font-bold uppercase tracking-widest text-[11px]">{edu.school}</p>
                  </motion.div>
                ))}
              </div>
            </div>
            <div>
              <h2 className="text-4xl lg:text-6xl font-black tracking-tighter mb-20 text-white">Certifications</h2>
              <div className="grid grid-cols-1 gap-4">
                {CERTIFICATIONS.map((cert, i) => (
                  <motion.div 
                    ...
                    className="p-6 rounded-2xl bg-[#0a0f1e]/60 backdrop-blur-xl border border-slate-800 flex items-center gap-6 group hover:border-cyan-500/30 transition-all shadow-2xl"
                  >
                    <div className="w-12 h-12 rounded-xl bg-[#111827] flex items-center justify-center text-cyan-400 group-hover:bg-cyan-500 group-hover:text-white transition-all">
                      <CheckCircle2 size={24} />
                    </div>
                    <div>
                      <div className="text-sm font-bold text-slate-100 mb-1">{cert.title}</div>
                      <div className="text-[10px] font-bold uppercase tracking-widest text-slate-500">{cert.issuer}</div>
                    </div>
                  </motion.div>
                ))}
              </div>
