...
export const CONFIG = {
  ...
  summary: "Full-Stack Software Engineer with over 3.5 years of experience specializing in scalable backend architectures using NodeJS and NestJS. I excel at designing high-performance multi-tenant SaaS and HIPAA-compliant healthcare systems. My expertise spans database optimization, event-driven workflows, and modern frontend interfaces, consistently delivering reliable production-ready applications.",
};
